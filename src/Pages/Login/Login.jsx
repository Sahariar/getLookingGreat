        ...
        .then((result) => {
			...
			const presentUser = {
			 ...
			 fetch('https://b6a11-service-review-server-side-sahariar.vercel.app/jwt', {
				...
				.then(data => {
					console.log(data);
					localStorage.setItem('GLG-token', data.token);
		...
		<section className="login-area mb-12">
            ...
            <div className="container mx-auto">
                <div className="text-center py-20 my-10">
                    <h2 className="mb-05 text-5xl font-extrabold mb-5">Login Page</h2>
                    <h4 className="subtitle text-xl">Home - Login</h4>
                </div>
            </div>
        </div>
            <div className="container mx-auto">
            <div className="flex">
			<div className=" lg:w-6/12 lg:max-w-md p-8 mx-auto from-secondary via-white to-transparent bg-gradient-to-br rounded-md shadow">
